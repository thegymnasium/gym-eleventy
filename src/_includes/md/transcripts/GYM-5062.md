...
If you need help with that, go to [docs.midjourney.com][1]{: target="_blank" rel="noopener"} to learn more. Now let’s dive in.

In the **Message** field at the bottom of the Discord interface, *type* the <kbd>/</kbd> (slash) key. From the commands that appear, choose **Imagine**. Everything you type after this will be the description of what you want to see.
...
Then *press* <kbd>Return</kbd>. After a few moments, you’ll get four variations back.
...
And let’s look at 100% magnification. And you can see, yeah, in this upscaled image, the amount of detail is pretty significant. To download this image locally from your browser, <kbd>Control</kbd> + *click* or *right-click* the image, and then choose **Save Image As…** to the location of your choice.
